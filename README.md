...
> 基于 Electron + Vue 3 + Python FastAPI 的智能康复科患者管理系统
...
康复科助手是一款专为康复科设计的智能化患者管理桌面应用，集成AI病程记录生成、患者信息管理、智能提醒系统、模板管理等功能，大幅提升医疗记录工作效率。

### 核心功能

- 🤖 **AI智能生成** - 基于患者信息和AI技术自动生成标准病程记录
- 👤 **患者管理** - 从首次病程记录AI自动提取患者信息，支持在院/出院患者管理
- 📋 **按日补记录** - 时间轴方式展示，快速补录缺失记录，支持卡片展开式交互
- ⏰ **智能提醒** - 自动提醒重要时间节点，支持今日/明日提醒，点击跳转患者
- 📝 **模板管理** - 丰富的预设模板库，支持4大临床类别，快速插入常用语句
- 🔔 **提醒系统** - 智能提醒（入院第2天检查、每15天评估、85天复查）
- 📊 **数据统计** - 实时统计患者数量、记录完成度、提醒数量
- 💾 **本地优先** - 核心功能本地运行，数据安全可控
