...
class MainWindow(ctk.CTk):
    ...
    def _create_navbar(self):
        ...
        ctk.CTkLabel(left_frame, text="康复科助手", font=Fonts.TITLE_MEDIUM).pack(side="left", padx=10)
    ...
    def _create_sidebar(self):
        ...
        ctk.CTkLabel(header, text="今日待办", font=Fonts.TITLE_MEDIUM).pack(side="left")
        ctk.CTkLabel(header, text="12", font=Fonts.TITLE_MEDIUM, text_color=Colors.PRIMARY).pack(side="right")
    ...
    def _create_workspace(self):
        ...
        ctk.CTkLabel(info_frame, text="患者信息", font=Fonts.TITLE_MEDIUM).pack(anchor="w", padx=15, pady=10)
        ...
        ctk.CTkLabel(note_frame, text="病程记录生成", font=Fonts.TITLE_MEDIUM).pack(anchor="w", padx=15, pady=10)

        # 当日情况输入
        ctk.CTkLabel(note_frame, text="当日情况：", font=Fonts.BODY).pack(anchor="w", padx=15)
        ...
        # 预览区域
        ctk.CTkLabel(note_frame, text="AI生成预览：", font=Fonts.BODY).pack(anchor="w", padx=15)
    ...
    def _create_quick_tools(self):
        ...
        ctk.CTkLabel(tools, text="快速模板", font=Fonts.TITLE_MEDIUM).pack(anchor="w", padx=15, pady=15)

        # 模板选择器
        # TODO: 添加模板下拉框

        # 常用短语
        ctk.CTkLabel(tools, text="常用短语", font=Fonts.BODY).pack(anchor="w", padx=15, pady=(10, 5))
